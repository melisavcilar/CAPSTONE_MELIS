...
DATABASES = {
    'default': {
        ...
        'HOST':  'aws-capstone-rds.cfshzktiyaky.us-east-1.rds.amazonaws.com', # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesmelisblog' # please enter your s3 bucket name
